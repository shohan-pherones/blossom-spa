...
const Services = () => {
  return (
    <section className="services-section py-20 container mx-auto">
      ...
      <div className="services flex flex-col gap-20">
        {/* Service 1 */}
        <div className="service grid grid-cols-1 lg:grid-cols-5 gap-5 items-center">
          ...
          <div className="service-r col-span-2 bg-teal-500 mt-5 lg:mt-0">
            <img
              src={serviceImg1}
        ...
        {/* Service 2 */}
        <div className="service grid grid-cols-1 lg:grid-cols-5 gap-5 items-center">
          <div className="service-l col-span-2 row-start-2 lg:row-start-auto mt-5 lg:mt-0">
            <img
              src={serviceImg2}
              alt="Woman Taking a Floral Bath and Listening to Music on Headphones"
            />
          </div>
          <div className="service-r col-span-3 flex flex-col gap-5 lg:w-4/5 justify-self-end">
