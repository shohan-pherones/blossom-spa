...
const Subscribe = () => {
  return (
    <section className="newsletter-section container mx-auto py-20 grid grid-cols-1 lg:grid-cols-2 gap-5 items-center text-center lg:text-left">
      <div className="newsletter-l lg:w-[80%] overflow-hidden relative">
        <img
          src={subscribeImg}
      ...
      <div className="newsletter-r flex flex-col gap-5 mt-5 lg:mt-0">
        ...
        <form className="flex gap-5 items-center mt-5 justify-center lg:justify-start">
          <input
            type="email"
